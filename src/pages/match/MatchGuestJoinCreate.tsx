  ...
  return (
    <div className="match_guest_create_page match_guest_join_create_page">
      ...
      <main className="match_guest_create_body">
        ...
        <section className="mgc_level_card" aria-labelledby="mgj-level-2">
          <div className="mgc_level_title">
          ...
          <article className="mgc_info_card">
            ...
            <div className="mgc_join_count_group">
              <div className="mgc_info_row">
                <span className="mgc_count_label body_m_16">참여인원</span>
                <div className="mgc_count_control" aria-label="참여인원 선택">
                  <button type="button" onClick={decreaseParticipantCount} aria-label="참여인원 줄이기">-</button>
                  <span>{participantCount}</span>
                  <button type="button" onClick={increaseParticipantCount} aria-label="참여인원 늘리기">+</button>
                </div>
              </div>
              <p className="mgc_join_count_hint">용병 지원은 최대 2명까지 가능해요.</p>
            </div>
          </article>
        </section>

        <section className="mgc_level_card" aria-labelledby="mgj-level-3">
          <div className="mgc_level_title">
            <span className="mgc_level_number">3</span>
            <h2 id="mgj-level-3" className="body_m_20">제목과 내용을 입력해주세요.</h2>
          </div>
