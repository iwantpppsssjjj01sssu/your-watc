              ...
              <div className="reserve_detail_wrapper">
                ...
                <div className="reserve_detail_content">
                  ...
                  <section className="reserve_detail_section">
                    ...
                    <p className="reserve_section_sub plan_section_sub">
              ...
              <>
                ...
                <section className="care_history_section">
                  <div className="care_history_header_row">
                    <button
                      type="button"
                      className="care_section_toggle_btn care_section_toggle_btn--history"
                    ...
                    <div
                      className="care_section_right_group"
                      data-expanded={expandedCareSections.has("history")}
                    >
                      <button
                        type="button"
                      ...
                      <svg
                        className="care_section_chevron"
                        viewBox="0 0 24 24"
                        width="18"
                        height="18"
                        fill="none"
