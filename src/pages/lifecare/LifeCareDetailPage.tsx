...
function KnitIllustration() {
  return (
    <svg viewBox="0 0 120 120" className="care_svg_illustration" aria-hidden="true">
      <defs>
      ...
      {/* 니트 실 뭉치 느낌의 라인들 */}
      <path d="M 40 40 C 50 30, 70 30, 80 40 C 90 50, 90 70, 80 80 C 70 90, 50 90, 40 80 C 30 70, 30 50, 40 40 Z" 
        fill="none" stroke="#d97706" strokeWidth="4" strokeLinecap="round" />
      <path d="M 48 48 C 55 42, 65 42, 72 48 C 78 54, 78 66, 72 72 C 65 78, 55 78, 48 72 C 42 66, 42 54, 48 48 Z" 
        fill="none" stroke="#f59e0b" strokeWidth="3" strokeLinecap="round" />
      {/* 뜨개질 바늘 */}
      <line x1="30" y1="90" x2="75" y2="45" stroke="#78350f" strokeWidth="4" strokeLinecap="round" />
      <circle cx="75" cy="45" r="4" fill="#78350f" />
      <line x1="90" y1="90" x2="45" y2="45" stroke="#78350f" strokeWidth="4" strokeLinecap="round" />
...
function CoatIllustration() {
  return (
    <svg viewBox="0 0 120 120" className="care_svg_illustration" aria-hidden="true">
      ...
      {/* 옷걸이와 코트 실루엣 */}
      <path d="M 40 45 L 60 32 L 80 45 M 60 32 L 60 25 C 60 20, 65 20, 65 25" 
        fill="none" stroke="#1e3a8a" strokeWidth="4" strokeLinecap="round" />
      <path d="M 35 48 C 45 48, 50 52, 60 52 C 70 52, 75 48, 85 48 L 90 95 L 30 95 Z" 
        fill="#2563eb" opacity="0.9" />
      <path d="M 52 52 L 52 95 M 68 52 L 68 95" 
        fill="none" stroke="#1d4ed8" strokeWidth="2" />
      {/* 깃 */}
      <path d="M 45 48 L 60 65 L 75 48" 
        fill="none" stroke="#1e3a8a" strokeWidth="3.5" strokeLinecap="round" />
    </svg>
  );
}
...
function ShirtIllustration() {
  return (
    <svg viewBox="0 0 120 120" className="care_svg_illustration" aria-hidden="true">
      ...
      {/* 셔츠 실루엣 */}
      <path d="M 30 45 L 45 40 L 60 45 L 75 40 L 90 45 L 85 95 L 35 95 Z" 
        fill="#0284c7" opacity="0.9" />
      {/* 카라(깃) */}
      <path d="M 45 40 L 60 55 L 75 40 L 68 35 L 60 40 L 52 35 Z" 
        fill="#0369a1" />
      {/* 단추 라인 및 단추 */}
...
const GUIDE_DATA: Record<string, GuideContent> = {
  yarn: {
    ...
    quiz: {
      ...
      answerIdx: 1,
      explanation: "정답입니다! 니트는 옷걸이에 걸면 흘러내리고, 압축 팩에 보관하면 고유의 포근한 섬유 공기층이 완전히 뭉개져 거칠어집니다. 한지와 함께 부드럽게 접어 눕히는 것이 최고의 보관 비법입니다. 🌟"
    }
  },
  coat: {
    ...
    quiz: {
      question: "세탁소에서 드라이클리닝 후 씌워준 비닐 커버, 그대로 보관해야 할까요?",
      options: [
      ...
      answerIdx: 1,
      explanation: "정답입니다! 드라이클리닝 비닐 커버는 휘발성 유기 용제가 갇혀 옷감을 상하게 하고 습기를 모아 곰팡이를 번식시킵니다. 꼭 비닐을 벗겨 그늘에서 하루 말린 후 바람이 통하는 부직포 커버로 갈아 끼워 주세요! 🌟"
    }
  },
  shirt: {
    ...
    tips: [
      ...
      },
      {
        ...
        subTip: "💡 완전히 식고 건조된 셔츠만이 최상의 빳빳함을 오랫동안 보존할 수 있습니다."
      }
    ],
    watcOption: {
    ...
    quiz: {
      question: "스팀 다림질을 끝낸 반듯한 셔츠, 언제 옷장에 넣어야 가장 좋을까요?",
      options: [
      ...
      answerIdx: 1,
      explanation: "정답입니다! 뜨거운 다림질 습기를 머금은 채 곧장 밀폐 옷장으로 가면, 구김이 더 세게 굳어질 뿐만 아니라 섬유 손상과 냄새의 원인이 됩니다. 충분히 식히는 ‘에이징 시간’ 30분이 필수입니다! 🌟"
    }
  }
};
  ...
  return (
    <div className="lifecare_detail_wrapper">
      <div className="lifecare_detail_container">
        ...
        {/* 상단 히어로 비주얼 배너 영역 */}
        <section className="detail_hero_section" style={{ borderBottomColor: content.primaryColor }}>
          <div className="hero_visual_container">
            {content.illustration}
          </div>
          <div className="hero_text_container">
            <span className="hero_badge" style={{ backgroundColor: content.accentBg, color: content.primaryColor }}>
              {content.badgeText}
            </span>
        ...
        <section className="detail_tips_section">
          <h2 className="section_title">
            <span className="section_title_indicator" style={{ backgroundColor: content.primaryColor }}></span>
            전문가 전수 3대 보관 비책
          </h2>
          ...
          <div className="tips_cards_container">
            {content.tips.map((tip, idx) => (
              <div key={idx} className="tip_card">
                ...
                <div className="tip_card_subtip" style={{ backgroundColor: content.accentBg, borderLeftColor: content.primaryColor }}>
                  <p className="tip_card_subtip_text" style={{ color: "#475569" }}>
                    {tip.subTip}
                  </p>
                </div>
              </div>
        ...
        {/* 왓씨 보관 연계 추천 서비스 배너 */}
        <section className="detail_watc_banner" style={{ borderLeftColor: content.primaryColor }}>
          <span className="watc_banner_tag" style={{ backgroundColor: content.primaryColor }}>
            왓씨 특화 솔루션
          </span>
          ...
          <div className="watc_banner_footer">
            <span className="watc_banner_badge" style={{ color: content.primaryColor, backgroundColor: content.accentBg }}>
          ...
          <div className="quiz_card">
            ...
            {!quizSubmitted ? (
              <button
                ...
                style={{ backgroundColor: selectedQuizIdx === null ? "#cbd5e1" : content.primaryColor }}
              >
                정답 제출하고 해설 확인
              </button>
            ) : (
              <div className="quiz_result_container animate_fade_in">
                <div className={`quiz_result_banner ${quizIsCorrect ? "correct" : "incorrect"}`}>
                  {quizIsCorrect ? (
                ...
                <button
                  ...
                  style={{ color: content.primaryColor, borderColor: content.primaryColor }}
                >
                  다시 풀어보기
                </button>
              </div>
